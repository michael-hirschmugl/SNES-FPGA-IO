...
HD_PWD='C:/Users/u15q86/Documents/git/SNES-FPGA-IO/direct-io/direct-io.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log direct_io_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source direct_io_top.tcl
