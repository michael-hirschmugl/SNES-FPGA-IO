...
HD_PWD='C:/Users/u15q86/Documents/git/SNES-FPGA-IO/direct-io/direct-io.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log direct_io_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source direct_io_top.tcl -notrace
